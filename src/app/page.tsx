...
import { ArrowRightIcon, CheckIcon, SparklesIcon, ChartBarIcon, LightBulbIcon, RocketLaunchIcon } from '@heroicons/react/24/outline';
...
const PricingCard = ({ plan, price, features, popular = false, delay = 0 }: {
  plan: string;
  price: string;
  features: string[];
  popular?: boolean;
  ...
  >
    ...
    <div className={`relative bg-white/90 backdrop-blur-sm border ${popular ? 'border-blue-300' : 'border-gray-200'} rounded-xl p-6 hover:bg-white transition-all duration-300 shadow-lg`}>
      ...
      <nav className="relative z-10 px-6 py-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <span className="text-2xl font-bold font-mono text-gray-800">ConvertIQ</span>
          </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            <div className="inline-flex items-center bg-blue-50 border border-blue-200 rounded-full px-4 py-2 mb-8">
              ...
              <span className="text-sm text-blue-700">AI-Powered Conversion Optimization</span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-gray-700 mb-12 max-w-3xl mx-auto leading-relaxed">
              Get data-driven insights and actionable recommendations that were once only available to enterprise companies. 
              Transform your small business website with AI-powered analysis.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              Our AI analyzes your website using proven psychology principles and UX best practices, 
              then provides specific recommendations you can implement today.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white/80 backdrop-blur-sm border border-blue-200/50 rounded-xl p-8 shadow-lg">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Local Services</h3>
                <p className="text-gray-700">Perfect for plumbers, electricians, consultants, beauty salons, and other service-based businesses.</p>
              </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm border border-blue-200/50 rounded-xl p-8 shadow-lg">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Creative Businesses</h3>
                <p className="text-gray-700">Ideal for photographers, designers, content creators, artists, and creative professionals.</p>
              </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm border border-blue-200/50 rounded-xl p-8 shadow-lg">
                ...
                <p className="text-gray-700">Great for online stores selling physical or digital products, dropshipping businesses, and marketplaces.</p>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-700 max-w-2xl mx-auto">
              Choose the plan that's right for your business. Start optimizing your conversions today.
            </p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-700 mb-8 max-w-2xl mx-auto">
              Join thousands of small businesses that have transformed their websites with ConvertIQ's AI-powered optimization.
            </p>
            
            <form onSubmit={handleEmailSubmit} className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto mb-6">
              <input
                type="email"
                value={email}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="flex items-center space-x-3 mb-4 md:mb-0">
              ...
              <span className="text-xl font-bold font-mono text-gray-800">ConvertIQ</span>
            </div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-200 text-center text-gray-600">
            <p>&copy; 2024 ConvertIQ. All rights reserved. Transform your website into a conversion machine.</p>
          </div>
        </div>
      </footer>
    </div>
