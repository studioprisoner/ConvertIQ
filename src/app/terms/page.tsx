...
export const metadata: Metadata = {
  ...
  description:
    "ConvertIQ's Terms of Service - Legal terms and conditions for using our platform.",
};
      ...
      <div className="prose prose-gray max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            By accessing or using ConvertIQ's website analysis and conversion
            optimisation service ("Service"), you agree to be bound by these
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            ConvertIQ provides website analysis, conversion optimization
            recommendations, and performance tracking services. Our Service
            includes:
          </p>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 text-gray-700 space-y-2">
            <li>
              Submit websites for malicious or unauthorized analysis purposes
            </li>
            <li>
              Use the Service to analyze illegal, harmful, or offensive content
            </li>
            <li>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            Our Service operates on a subscription basis with different plan
            tiers:
          </p>
          <ul className="list-disc pl-6 text-gray-700 space-y-2">
            <li>
              <strong>Basic Plan:</strong> Limited features with basic website
              analysis
            </li>
            <li>
              <strong>Pro Plan:</strong> Enhanced features with multiple domain
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            ...
            owned by ConvertIQ and protected by copyright, trademark, and other
            intellectual property laws. You retain ownership of your website
            content, but grant us permission to analyze it for the purposes of
            providing our Service.
          </p>
          <p className="text-gray-700 leading-relaxed">
            Our analysis reports and recommendations are provided for your use
            only and may not be redistributed or resold without our permission.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            maintenance, updates, or other operational reasons. We are not
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            You agree to defend, indemnify, and hold harmless ConvertIQ from and
            against any claims, damages, obligations, losses, liabilities,
            costs, or debt arising from your use of the Service, violation of
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            to the exclusive jurisdiction of the courts in Australia.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            contact our support team through the in-app support system or email
            us at the contact information provided on our website.
          </p>
        </section>
      </div>
    </div>
